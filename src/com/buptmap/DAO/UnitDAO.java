...
public class UnitDAO {
	...
	public JSONArray findVersion(String unitid){
		List<Object[]> result = new ArrayList<Object[]>();
		try{
			result = hibernateTemplate.find("select version_id,unitVersion,unit_id,isAvailable,description,createTime,lastModifyTime,finishVersionTime " +
			...
			for(int i=0;i<result.size();i++){
				...
				jsonObject.put("finishVersionTime", resultObj[7]==null?"":resultObj[7]);
				jsonArray.add(jsonObject);
			}
			return jsonArray;
		}catch(Exception e){
