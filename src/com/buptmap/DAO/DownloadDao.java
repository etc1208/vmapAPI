...
public class DownloadDao {
	...
	public boolean getUserData(){
		...
		try{
			WritableWorkbook book = Workbook.createWorkbook(new File("E:\\programTools\\Tomcat7.0\\webapps\\vmapAPI\\userData.xls"));
	...
	public boolean getLeaseData(){
		...
		try{
			WritableWorkbook book = Workbook.createWorkbook(new File("E:\\programTools\\Tomcat7.0\\webapps\\vmapAPI\\leaseData.xls"));
			WritableSheet sheet = book.createSheet("第一页", 0);
	...
	public boolean getConsultData(){
		...
		try{
			WritableWorkbook book = Workbook.createWorkbook(new File("E:\\programTools\\Tomcat7.0\\webapps\\vmapAPI\\consultData.xls"));
			WritableSheet sheet = book.createSheet("第一页", 0);
	...
	public boolean getfile(String unitid, String versionid, String floorid){
        ...
        try { 
            ...
            //t.xls为要新建的文件名
        	int j = 0;  
            WritableWorkbook book= Workbook.createWorkbook(new File("E:\\programTools\\Tomcat7.0\\webapps\\vmapAPI\\total.xls")); 
   ...
   public boolean proxygetfile(String unitid, String versionid, String floorid,String proxyid){
        ...
        try { 
            ...
            //t.xls为要新建的文件名
        	int j = 0;
            WritableWorkbook book= Workbook.createWorkbook(new File("E:\\programTools\\Tomcat7.0\\webapps\\vmapAPI\\"+ proxyid +".xls")); 
            //生成名为“第一页”的工作表，参数0表示这是第一页 
            WritableSheet sheet=book.createSheet("第一页",0); 
